...
async def start(client, message):
    ...
    buttons = [
        ...
        [
            ...
            InlineKeyboardButton('⚙️ Update Channel', url='https://t.me/baduseruyir'),

            InlineKeyboardButton('🧩 Source', url='https://github.com/baduseruyir/VCPlayerBot')
...
async def repo_(client, message):
    ...
    buttons = [
        ...
        [
            ...
            InlineKeyboardButton('🧩 Repository', url='https://github.com/baduseruyir/VCPlayerBot'),
